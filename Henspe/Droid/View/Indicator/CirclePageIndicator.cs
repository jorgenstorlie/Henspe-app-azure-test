...
{
	public class CirclePageIndicator : global::Android.Views.View, IPageIndicator
    {
		...
		private global::Android.Support.V4.View.ViewPager mViewPager;
		private global::Android.Support.V4.View.ViewPager.IOnPageChangeListener mListener;
		...
		public void SetViewPager(global::Android.Support.V4.View.ViewPager view)
        {
		...
		public void SetViewPager(global::Android.Support.V4.View.ViewPager view, int initialPosition)
        {
            SetViewPager(view);
        ...
        {
			if (mSnap || mScrollState == global::Android.Support.V4.View.ViewPager.ScrollStateIdle)
            {
                mCurrentPage = position;
                mSnapPage = position;
                Invalidate();
		...
		public void SetOnPageChangeListener(global::Android.Support.V4.View.ViewPager.IOnPageChangeListener listener)
        {
            mListener = listener;
        }
