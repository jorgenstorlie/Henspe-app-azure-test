    ...
    public class LocationUpdatesService : Service
    {
        ...
        Notification GetNotification()
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .AddAction(Resource.Drawable.ic_brann, GetString(Resource.String.launch_activity),
                    activityPendingIntent)
                .AddAction(Resource.Drawable.ic_ankomst, GetString(Resource.String.remove_location_updates),
