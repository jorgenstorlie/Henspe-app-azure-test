...
namespace Henspe.iOS
{
    public partial class SettingsCoordinateFormatViewController : UIViewController
    {
        ...
        {
            return settingsCoordinateFormatTableViewSource.coordinateRows.IndexOf(settingsCoordinateFormatTableViewSource.coordinateRows.First(x => x.CoordinateFormat == UserUtil.settings.format));
        }
        ...
        private void RowSelected(NSIndexPath indexPath)
        {
            ...
            UserUtil.settings.format = format;
        }
