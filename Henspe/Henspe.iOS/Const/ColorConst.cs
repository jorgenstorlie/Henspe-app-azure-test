...
namespace Henspe.iOS.Const
{
	public class ColorConst
	{
        ...
        public static UIColor snlaTextLight = UIColor.FromRGB(255, 255, 255); // White OK
        ...
        public static UIColor snlaBackground = UIColor.FromRGB(248, 243, 241); //OK
        public static UIColor headerBackgroundColor = UIColor.FromRGB(241, 236, 234);

        public static UIColor evenBackground = UIColor.FromRGB(241, 236, 234);  //OK
        public static UIColor oddBackgroundColor = UIColor.FromRGB(248, 243, 241); //OK


        public static UIColor headerTextColor = UIColor.FromRGB(107, 100, 100);  //OK
        public static UIColor tableSeparatorColor = UIColor.FromRGB(236, 236, 236);
        public static UIColor headerLineBackground = UIColor.FromRGB(220, 220, 220);  //OK
